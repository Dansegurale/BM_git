            ...
            <div class="row bg-primary order-lg-4">
                ...
                <div class="col dropdown p-0">
                    ...
                    <div class="dropdown-menu" aria-labelledby="IdiomPicker">
                        <?php echo anchor(site_url('AlumnesOfertes/index/cat'),'<img src="'.base_url('assets/own/img/catalan.png').'" alt="catalan" style="width:40px;height:20px;">','class="dropdown-item"')?>
                        <?php echo anchor(site_url('AlumnesOfertes/index/es') ,'<img src="'.base_url('assets/own/img/spanish.png').'" alt="spanish" style="width:40px;height:20px;">','class="dropdown-item"')?>
                        <?php echo anchor(site_url('AlumnesOfertes/index/en') ,'<img src="'.base_url('assets/own/img/english.png').'" alt="english" style="width:40px;height:20px;">','class="dropdown-item"')?>
                    </div>
                </div>
                <div class="col p-0">
